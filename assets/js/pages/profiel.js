$( document ).ready(function() {
    ...
    FYSCloud.API.queryDatabase(
        "SELECT hobby FROM interesse INNER JOIN profiel_has_interesse ON profiel_has_interesse.Interesse_id = interesse.id_hobby WHERE Profiel_id = ?", [FYSCloud.Session.get("userid")]
    ).done(function (data) {
